...
const ExamCategories = () => {
  const examCategories = [
    ...
    { id: 2, primaryLabel: 'SSC', secondaryLabel: 'GD', link: '' },
    { id: 3, primaryLabel: 'SSC', secondaryLabel: 'CGL', link: '' },
    { id: 4, primaryLabel: 'SSC', secondaryLabel: 'CHSL', link: '' },
    { id: 5, primaryLabel: 'Railway', link: '' },
    { id: 6, primaryLabel: 'RAS', link: '' },
    { id: 7, primaryLabel: 'RPSC', secondaryLabel: 'Teacher First Grade', link: '' },
    { id: 8, primaryLabel: 'RPSC', secondaryLabel: 'Teacher Second Grade', link: '' },
    { id: 9, primaryLabel: 'RPSC', secondaryLabel: 'Teacher Third Grade', link: '' },
    { id: 10, primaryLabel: 'REET', link: '' },
    { id: 11, primaryLabel: 'Jr. Accountant', link: '' },
    { id: 12, primaryLabel: 'S.I. (Rajasthan Police)', link: '' },
    { id: 13, primaryLabel: 'Constable (Rajasthan Police)', link: '' },
    { id: 14, primaryLabel: 'Patwari', link: '' },
    { id: 15, primaryLabel: 'LDC', link: '' },
  ];
